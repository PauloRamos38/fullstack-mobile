...
- Email: pauloramos38.dev@gmail.com
...
- Atualize a URL da API no arquivo `App.js`
- Use o IP correto da sua máquina local
- No Android Emulator, use `10.0.2.2` ao invés de `localhost`
...
Encontrou algum problema? Abra uma [issue](https://github.com/PauloRamos38/fullstack-mobile/issues) no GitHub.
